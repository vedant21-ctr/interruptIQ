    ...
    <div className="glass-card p-6 flex-1 flex flex-col h-full relative overflow-hidden">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs uppercase tracking-[0.2em] font-black text-zinc-400">
        ...
        <div className="absolute inset-0 overflow-y-auto pr-2 scrollbar-hide flex flex-col gap-4">
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div
                      className={`w-3 h-3 rounded-full ${dotBg} shadow-[0_0_12px_currentColor]`}
                    />
                    <div>
                      <div className="text-sm font-semibold text-zinc-200 capitalize tracking-wide">
                        {log.type} Context
                      </div>
                  ...
                  <div
                    className={`text-xs font-black uppercase tracking-[0.2em] px-3 py-1.5 rounded-full bg-black/40 ${colorTag}`}
                  >
                    {log.decision}
                  </div>
                </motion.div>
          ...
          {logs.length === 0 && (
            <div className="h-full flex flex-col items-center justify-center opacity-50">
              <svg
                className="w-12 h-12 text-zinc-600 mb-4 animate-bounce"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
              ...
              <div className="text-zinc-500 text-sm italic tracking-widest uppercase">
                Waiting for logs...
              </div>
            </div>
          )}
